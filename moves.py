...
def move_R(cube):
    ...
    cube['B'][0], cube['B'][2] = u_right
    cube['D'][1], cube['D'][3] = b_left
...
def move_F(cube):
    ...
    l_right = cube['L'][1], cube['D'][3]

    cube['U'][2], cube['U'][3] = l_right
    cube['R'][0], cube['R'][2] = u_bottom
    cube['D'][0], cube['D'][1] = r_left
    cube['L'][1], cube['D'][3] = d_top
